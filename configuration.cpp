...
const keyboard_configuration_t configurations[NUM_CONFIGURATION] = {
    {
        .button = { // Configuration KVM switch
            [BTN_1] = {
                .type = BUTTON_SEQUENCE,
                .function.sequence = {
                    .sequence = {KEY_LEFT_CTRL, KEY_LEFT_CTRL, '3'}, // ctrl + ctrl + 3
                    .length = 3,
                    .delay = 50
                }
            },
            [BTN_2] = {
                .type = BUTTON_SEQUENCE,
                .function.sequence = {
                    .sequence = {KEY_LEFT_CTRL, KEY_LEFT_CTRL, '2'}, // ctrl + ctrl + 2
                    .length = 3,
                    .delay = 50
                }
            },
            [BTN_3] = {
                .type = BUTTON_SEQUENCE,
                .function.sequence = {
                    .sequence = {KEY_LEFT_CTRL, KEY_LEFT_CTRL, '1'}, // ctrl + ctrl + 1
                    .length = 3,
                    .delay = 50
                }
            },
